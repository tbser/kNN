...
def classify0(inX, dataSet, labels, k):
    ...
    distances = sqDistances**0.5  # 开根号，得距离
...
# 为了使用前面两个例子的分类器,必须将图像格式化处理为一个向量。把一个32x32的二进制图像矩阵转换为1x1024的向量。
...
def handwritingClassTest():
    ...
    for i in range(m):
        ...
        # 0_1.txt     fileNameStr.split('.') : ['0_1', 'txt']
        fileStr = fileNameStr.split('.')[0]         # 0_1  take off .txt
